...
class NonArchived{{ cookiecutter.model_name|capitalize }}Manager(models.Manager):
    def get_query_set(self):
        return super(NonArchived{{ cookiecutter.model_name|capitalize }}Manager, self).get_query_set().exclude(status='Archived')
...
class {{ cookiecutter.model_name }}(StatusModel, TimeStampedModel):
    ...
    objects = NonArchived{{ cookiecutter.model_name|capitalize }}Manager()
